...
"""
<dl class="detail" style="background:rgba(231,218,177,.2)">
<dt>1．基礎理論</dt>
<dd>(離散数学・応用数学・情報理論・通信理論・計測制御理論)</dd>
<dt>2．アルゴリズムとプログラミング<br>
</dt><dd>(データ構造・アルゴリズム・プログラミング・プログラム言語・マークアップ言語など)</dd>
<dt>3．コンピュータ構成要素</dt>
...
<dt>6．ハードウェア</dt>
<dd>(ハードウェア全般)</dd>
<dt>7．ヒューマンインターフェイス</dt>
<dd>(ヒューマンインターフェイス技術・インターフェイス設計)</dd>
<dt>8．マルチメディア</dt>
...
<dl class="detail" style="background:rgba(182,218,201,.2)">
<dt>14．プロジェクトマネジメント</dt>
<dd>(プロジェクトマネジメント・プロジェクトの統合・プロジェクトのステークホルダ・プロジェクトのスコープ・プロジェクトの資源、プロジェクトの時間・プロジェクトのコスト・プロジェクトのリスク、プロジェクトの品質・プロジェクトの調達・プロジェクトのコミュニケーション)</dd>
<dt>15．サービスマネジメント</dt>
...
<dl class="detail" style="background:rgba(168,193,208,.2)">
<dt>17．システム戦略</dt>
